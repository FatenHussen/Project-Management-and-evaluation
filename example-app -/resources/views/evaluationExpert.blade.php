                  ...
                  <tfoot>
                    <tr>
                      <td colspan="" style=" display: flex;
                                              ...
                                              height: 100%;">
                        @if($predictions === 'dark red')
                          <div class="dark_red"></div>
                        @elseif($predictions === 'normal red')
                          <div class="red"></div>
                          @elseif($predictions === 'light red')
                          <div class="light_red"></div>
                        @elseif($predictions === 'light orange')
                          <div class="light_orange"></div>
                          @elseif($predictions === 'normal orange')
                          <div class="orange"></div>
                        @elseif($predictions === 'dark orange')
                          <div class="dark_orange"></div>
                          @elseif($predictions === 'light green')
                          <div class="light_green"></div>
                        @elseif($predictions === 'normal green')
                          <div class="green"></div>
                        @elseif($predictions === 'dark green')
